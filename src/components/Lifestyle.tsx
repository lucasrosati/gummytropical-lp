      ...
      <div className="mx-auto max-w-7xl px-5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="text-center lg:text-left">
            <h2 className="font-heading text-2xl lg:text-[36px] lg:leading-[44px] font-light text-brand-text">
            ...
            <p className="mt-6 lg:mt-8 font-body text-sm lg:text-base lg:leading-[26px] font-light text-brand-text max-w-[480px]">
            ...
            <button
              ...
              className="mt-8 lg:mt-10 inline-block rounded-[56px] px-10 lg:py-4 font-heading font-semibold text-brand-cta-text text-base transition-transform hover:scale-[1.02] cursor-pointer"
              style={{
